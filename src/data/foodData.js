const foodData = [
    {
        id: 'food-01',
        image: process.env.PUBLIC_URL+'/images/food/food_01.jpg',
        desc: '60개입 대용량 팩으로 즐기는 휴먼그레이드 참치 스틱 간식',
        title: '퓨어 튜나 스틱 버라이어티팩',
        item: 'PURE TUNA STICK VARIETY PACK',
        price: '34,900',
        details: (
            <>
            태평양에서 잡은 신선한 참치! 참치 명가 동원의 노하우를 듬뿍 담아 더욱 더 맛있는 100% 휴먼그레이드 간식을 대용량 팩으로<br/>페스룸 퓨어 튜나 스틱 버라이어티 팩!
            </>
        )
    },
    {
        id: 'food-02',
        image: process.env.PUBLIC_URL+'/images/food/food_02.jpg',
    ...
    {
        id: 'food-03',
        image: process.env.PUBLIC_URL+'/images/food/food_03.jpg',
    ...
    {
        id: 'food-04',
        image: process.env.PUBLIC_URL+'/images/food/food_04.jpg',
    ...
    {
        id: 'food-05',
        image: process.env.PUBLIC_URL+'/images/food/food_05.jpg',
    ...
    {
        id: 'food-06',
        image: process.env.PUBLIC_URL+'/images/food/food_06.jpg',
    ...
    {
        id: 'food-07',
        image: process.env.PUBLIC_URL+'/images/food/food_07.jpg',
    ...
    {
        id: 'food-08',
        image: process.env.PUBLIC_URL+'/images/food/food_08.jpg',
    ...
    {
        id: 'food-09',
        image: process.env.PUBLIC_URL+'/images/food/food_09.jpg',
    ...
    {
        id: 'food-10',
        image: process.env.PUBLIC_URL+'/images/food/food_10.jpg',
    ...
    {
        id: 'food-11',
        image: process.env.PUBLIC_URL+'/images/food/food_11.jpg',
    ...
    {
        id: 'food-12',
        image: process.env.PUBLIC_URL+'/images/food/food_12.jpg',
    ...
    {
        id: 'food-13',
        image: process.env.PUBLIC_URL+'/images/food/food_13.jpg',
    ...
    {
        id: 'food-14',
        image: process.env.PUBLIC_URL+'/images/food/food_14.jpg',
    ...
    {
        id: 'food-15',
        image: process.env.PUBLIC_URL+'/images/food/food_15.jpg',
